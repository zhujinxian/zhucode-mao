...
public class MongoComponentProvider implements ResourceLoaderAware {

    /**
     * 日志记录器
     */
    private final Log logger = LogFactory.getLog(MongoComponentProvider.class);

    /**
     * 
     */
    private String resourcePattern = "**/*MAO.class";
     ...
     * 
     */
    public MongoComponentProvider() {
        includeFilters.add(new AnnotationTypeFilter(MAO.class));
    }
